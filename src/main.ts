...
const aluno1 = new Aluno("Ana", "Silva", "ana.silva@gmail.com", "presencial", 1, new Date(2005, 5, 15), [9, 9, 8], true, "A");
...
const aluno9 = new Aluno("Juliana", "Ferreira", "juliana.ferreira@gmail.com", "ead", 2, new Date(2006, 3, 28), [1, 2, 4], true, "B");
const aluno10 = new Aluno("Paulo", "Almeida", "paulo.almeida@gmail.com", "presencial", 1, new Date(2005, 2, 17), [6, 6, 6], false, "B");
